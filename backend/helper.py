...
with open('crisis.csv', "w") as f:
    ...
    textWriter.writerow(['Country', 'Begin Date', 'End Date', 'Text'])
    for countryTuple in countries:
        ...
        for year in range(0,3):
            ...
            custom_item.click()
            beginDate = "01/01/"+str(2000 + (year * 5))
            endDate = "01/01/"+str(2000 + ((year + 1) * 5))
            ...
            search_button.click()
            elementList = driver.find_elements(By.CLASS_NAME, 'st')
            for webelement in elementList:
                smallHeader = webelement.text
                smallHeader = smallHeader[smallHeader.find('-')+1:]
                smallHeader = smallHeader.replace('...','')
                textWriter.writerow([country, beginDate, endDate, smallHeader])
